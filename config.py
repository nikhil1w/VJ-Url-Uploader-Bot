...
class Config(object):
    # Bot Information 
    TECH_VJ_BOT_TOKEN = os.environ.get("8289861130:AAEx2EphOkce9QJS1jZ_nmenb-4q7GBjQ0w", "")
    TECH_VJ_BOT_USERNAME = os.environ.get("TECH_VJ_BOT_USERNAME", "") # Bot username without @.
    
    # The Telegram API things
    TECH_VJ_API_ID = int(os.environ.get("24869695", ""))
    TECH_VJ_API_HASH = os.environ.get("5ee98927939d175ca953297fbe309f37", "")
    ...
    TECH_VJ_OWNER_ID = int(os.environ.get("7445620075", "")) 
    ...
    # channel information
    TECH_VJ_LOG_CHANNEL = int(os.environ.get("-1002702049353", "")) # your log channel id and make bot admin in log channel with full right 
    
    # if you want force subscribe then give your channel id below else leave blank
    tech_vj_update_channel = environ.get('-1002715248394', '') # your update channel id and make bot admin in update channel with full right
    TECH_VJ_UPDATES_CHANNEL = (-1002715248394) if tech_vj_update_channel and id_pattern.search(tech_vj_update_channel) else None  
...
# Don't Remove Credit Tg - @VJ_Bot
# Subscribe YouTube Channel For Amazing Bot https://youtube.com/@Teh_VJ
# Ask Doubt on telegram @nikhilbhaiiibot
